...
namespace MvcPet.Areas.Identity.Pages.Account
{
  ...
  public class RegisterModel : PageModel
  {
    ...
    public class InputModel
    {
      ...
      [StringLength(20, ErrorMessage = "A {0} precisar conter de {2} a {1} characteres .", MinimumLength = 6)]
      [DataType(DataType.Password)]
      [Display(Name = "Senha")]
      public string Password { get; set; }

      [Required(ErrorMessage = "É necessário repetir a Senha informada")]
    //   [StringLength(20, ErrorMessage = "A {0} precisar conter de {2} a {1} characteres .", MinimumLength = 6)]
      [DataType(DataType.Password)]
      ...
      if (ModelState.IsValid)
      {
        ...
        if (result.Succeeded)
        {
          ...
          await _emailSender.SendEmailAsync(Input.Email, "Confirme seu E-mail",
              $"Para que seu E-mail possa ser validado, <a href='{HtmlEncoder.Default.Encode(callbackUrl)}'>clique aqui.</a>.");
